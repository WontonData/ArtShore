<template>
	...
	<el-row class="empty-row100">
		
	</el-row>
	<el-main>
		<div class="main__head">
			<div class="main__stage">Create, explore, & collect digital art NFTs.</div>
			<h3 class="main__title h3">数字艺术品的黄金海岸</h3><a class="button-stroke main__button"  href="http://124.222.242.75:88/"> 即刻探索 </a>
		</div>
		...
		<div class="main__slide">
		  <div class="main__row">
		    <div class="player">
		      <div class="player__preview"><img srcSet="/static/img/content/video-preview@2x.jpg 2x" src="/static/img/content/video-preview.jpg" alt="Video preview"></div>
