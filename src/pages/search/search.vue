          ...
          <div class="catalog__center center">
            <div class="catalog__top">
              ...
              <form class="catalog__search">
                <input
                  class="catalog__input ex_catalog__input"
                  type="text"
                  name="search"
                  placeholder="Search..."
                  required
            ...
            <div class="catalog__row">
              <div class="catalog__filters">
                ...
                <a class="catalog__reset" @click="getList()"> 重新筛选</a>
              </div>
