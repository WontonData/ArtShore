	            ...
	            <div class="item__center center">
	              ...
	              <div class="item__details">
	                ...
	                <div class="item__control">
	                  ...
	                  <div class="item__btns"><a class="button item__button js-popup-open"  data-effect="mfp-zoom-in" @click="checkout = true">立即购买</a>
					  <a class="button-stroke item__button"  @click="share">分享</a></div>
	                  <div class="item__variants">创建于<span class="item__percent">2022/3/28</span> <span>版权所有，请勿用作商业用途</span></div>
	                </div>
	              </div>
	            </div>
	          </div>
