		...
		<view class="outer bg-opacity-0">
            ...
            ">
                ...
                " v-loading="isLoading">
								...
								<div v-show="!isFound && isSearch" class=" font-bold text-green-500">
									未找到相关NFT，您可上传此图片作为NFT</div>
                    ...
                    rounded-xl
                    border-2 border-solid
                  " v-if="isFound" :title="foundMeta.name" price="9.99" creater="xxx" :tokenid="foundMeta.token_id"
									:art_id="foundMeta.token_id" :address="foundMeta.address" :art_src="foundMeta.url">
								</card1>
							</div>
						</div>
					</div>
