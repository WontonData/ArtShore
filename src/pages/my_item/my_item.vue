...
<!-- 	                <div class="options">
	              ...
	              <div class="item__details">
	                ...
	                <div class="item__tabs js-tabs">
	                  <div class="item__nav"><a class="item__link js-tabs-link active" href="#">信息</a><a class="item__link js-tabs-link" href="#">创建者</a><a class="item__link js-tabs-link" href="#">评论</a></div>
	                ...
	                <div class="item__control">
	                  ...
	                  <div class="item__btns"><a class="button item__button js-popup-open"  data-effect="mfp-zoom-in" @click="checkout = true">转赠他人</a>
					  <a class="button-stroke item__button"  @click="share">分享</a></div>
	                  <div class="item__variants">购买于<span class="item__percent">2022/3/28</span> <span>版权所有，请勿用作商业用途</span></div>
	                </div>
	              </div>
	            </div>
	          </div>
			  ...
			  <el-dialog  v-model="checkout">
				 <div class="popup__item" style="display: block;">
				   ...
				   <div class="popup__btns">
				     <button class="button popup__button " style="width: 93%;" @click="topay">我要赠送</button>
				     <button class="button-stroke popup__button js-popup-close" style="width: 93%;"  @click="cancel1">取消</button>
				   </div>
				 </div>
			  </el-dialog>
			  
			  <el-dialog  v-model="paypage">
				  <div class="popup__item" style="display: block;">
				    ...
				    <div class="popup__btns">
				      <button class="button popup__button" style="width: 93%;" @click="payok">赠予</button>
				      <button class="button-stroke popup__button js-popup-close" style="width: 93%;" @click="cancelpay">放弃赠予</button>
				    </div>
				  </div>
			  </el-dialog>
			  
			  <el-dialog  v-model="buyok" >
				  <div class="popup__item" style="display: block;">
				    <div class="success">
				      ...
				      <button class="button popup__button" style="width: 93%;" @click="share">通知</button>
				    </div>
				  </div>
			  </el-dialog>
