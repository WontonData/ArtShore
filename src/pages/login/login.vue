<template>
  <view>
    <!-- <div
      ...
      class="-z-10absolute blur-sm"
    ></div> -->
    <div class="flex align-middle justify-items-center w-full justify-center">
      <!-- <div>123</div> -->
      <el-form
        ref="loginForm"
        :model="form"
        :rules="rules"
        label-width="80px"
        class="login-box backdrop-filter backdrop-blur-lg mt-[20%]"
      >
