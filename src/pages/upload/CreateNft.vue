		...
		<view class="outer bg-opacity-0">
            ...
            ">
						<div class="flex flex-col w-4/6 mt-5">
							...
							<FileSelectSingle class="w-40" @selected="onSelected2" :theFile="coverFile" />
						</div>
						...
						<div class="flex flex-col w-4/6 mt-5">
							...
							<div class="float-left text-left">
								<input type="text" class="border-gray-300 h-5 w-6/6 border-2" v-model="nft.symbol" />
							</div>
						</div>
						<div class="flex flex-col w-4/6 mt-5">
							<div class="float-left text-left title">描述 Description</div>
							<div class="float-left text-left">
								<input type="text" class="border-gray-300 h-58 w-6/6 border-2"
						...
						<div class="flex flex-col w-4/6 mt-5">
							...
							<div class="float-left text-left">
								<input type="text" class="border-gray-300 h-5 w-6/6 border-2" v-model="nft.price" />
								<el-date-picker v-if="priceType" v-model="endTime" type="datetime"
									placeholder="选择拍卖截止时间" :default-time="defaultTime" size="large" class="mt-1 mb-1" />
							</div>
							<el-switch v-model="priceType" class="mb-2 w-1/4" active-text="拍卖" inactive-text=""
								size="large" />
						</div>
