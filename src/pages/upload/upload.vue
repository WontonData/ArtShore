          ...
          <div class="variants__center center">
            ...
            <div class="variants__list">
              <div class="variants__item">
                <div class="variants__preview">
                  <img
                    srcSet="/static/img/content/upload-pic-1@2x.jpg 2x"
                    src="/static/img/content/upload-pic-1.jpg"
                    alt="Upload"
                  />
                </div>
                <a
              ...
              <div class="variants__item">
                <div class="variants__preview">
                  <img
                    srcSet="/static/img/content/upload-pic-2@2x.jpg 2x"
                    src="/static/img/content/upload-pic-2.jpg"
                    alt="Upload"
                  />
                </div>
                <a
                  class="button-stroke variants__button"
                  href="/#/pages/upload/CreateNft"
                  >创建集合</a
                >
              </div>
            </div>
            <div class="variants__list list2">
              <div class="variants__item item2">
                <div class="variants__preview">
                  <img
                    srcSet="/static/img/content/upload_pic3_2x.png 2x"
                    src="/static/img/content/upload_pic3.png"
                    alt="Upload"
                  />
                </div>
                <a
