...
$('.main__timer')
  .countdown('2050/04/28 00:00:00')
  .on('update.countdown', function (event) {
    var $this = $(this).html(
      event.strftime(
        '' +
          '<span class="main__box"><span class="main__number">%H</span><span class="main__time">Hrs</span></span>' +
          '<span class="main__box"><span class="main__number">%M</span><span class="main__time">mins</span></span>' +
          '<span class="main__box"><span class="main__number">%S</span><span class="main__time">secs</span></span>'
      )
    )
  })
