...
;(function () {
  $('.js-activity-select').on('click', function () {
    $('.activity__group .checkbox__input')
      .prop('checked', true)
...
;(function () {
  ...
  $(
    '.wallet__item:first-child .wallet__button, .wallet__item:first-child .wallet__code'
  ).on('click', function (e) {
    $('.wallet__item:first-child').hide()
    $('.wallet__item:nth-child(2)').show()
  })
  $('.wallet__item:nth-child(2) .wallet__button:first-child').on(
    'click',
    function (e) {
      $('.wallet__link').removeClass('active')
      $('.wallet__item').hide()
  ...
  $('.wallet__item:nth-child(2) .wallet__button:nth-child(2)').on(
    'click',
    function () {
...
;(function () {
  $('.discover__link, .activity__link, .catalog__link').on(
    'click',
    function (e) {
      e.preventDefault()
      $('.discover__link, .activity__link, .catalog__link').removeClass(
        'active'
      )
      $(this).addClass('active')
    }
...
$('.popup_purchase .popup__item .popup__button:first-child').on(
  'click',
  function () {
...
$('.popup_price .popup__button:first-child').on('click', function () {
  ...
  $('.item__currency .item__price:first-child').text(text)
})
