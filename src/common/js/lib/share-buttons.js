!(function (e, t) {
  ...
  var e = new (function () {
    ...
    this.i = function () {
      var e,
        t = m.querySelectorAll('.share-btn')
    ...
    var n = function (e) {
        ...
        for (t = n.length; t--; )
          r(n[t], { id: '', url: i(e), title: c(e), desc: o(e) })
      },
      r = function (e, t) {
        ;(t.id = h(e, 'data-id')), t.id && a(e, 'click', t)
      },
      i = function (e) {
        return h(e, 'data-url') || location.href || ' '
      },
      c = function (e) {
        return h(e, 'data-title') || m.title || ' '
      },
      o = function (e) {
        var t = m.querySelector('meta[name=description]')
        return h(e, 'data-desc') || (t && h(t, 'content')) || ' '
      },
      a = function (e, t, n) {
        function r() {
          d(n.id, n.url, n.title, n.desc)
        }
        e.addEventListener
      ...
      d = function (e, t, n, r) {
        ...
        switch (e) {
          ...
          case 'tw':
            ...
            break
          case 'tg':
            p(s('https://t.me/share/url?url={0}&text={1}', [i, u([o, c])]), n)
            break
          case 'pk':
            p(
            ...
            break
          case 're':
            p(s('https://reddit.com/submit?url={0}&title={1}', [i, o]), n)
            break
          case 'ev':
            p(
          ...
          case 'sk':
            ...
            break
          case 'wa':
            p(s('https://wa.me/?text={0}%20{1}', [u([o, c]), i]), n)
            break
          case 'ok':
            p(
              s(
      ...
      p = function (e, t) {
        var n = void 0 !== f.screenLeft ? f.screenLeft : screen.left,
          r = void 0 !== f.screenTop ? f.screenTop : screen.top,
          i =
            (f.innerWidth || m.documentElement.clientWidth || screen.width) /
              2 -
            300 +
            n,
          c =
            (f.innerHeight || m.documentElement.clientHeight || screen.height) /
              3 -
            400 / 3 +
            r,
          o = f.open(
