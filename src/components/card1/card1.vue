    ...
    <div class="card">
      <div class="card__preview">
        ...
        <div class="card__control">
          ...
          <a
            class="button-small card__button js-popup-open"
          ...
          <div class="card__line">
            <div class="card__users">
              <div class="card__avatar">
                <img src="/static/img/content/avatar-1.jpg" alt="Avatar" />
              </div>
              <div class="card__avatar">
                <img src="/static/img/content/avatar-3.jpg" alt="Avatar" />
              </div>
              <div class="card__avatar">
                <img src="/static/img/content/avatar-4.jpg" alt="Avatar" />
              </div>
            </div>
        ...
        <div class="card__foot">
          <div class="card__status">
            <svg class="icon icon-candlesticks-up">
              <use xlink:href="#icon-candlesticks-up"></use></svg
            >创作者： <span>{{ creater }}</span>
          </div>
          <div class="card__bid">
            状态：<span role="img" aria-label="fire">🔥</span>
          </div>
        </div></a
      >
    </div>
