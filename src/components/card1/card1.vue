				...
				<div class="card__body">
					...
					<div class="card__line">
						<div class="card__users">
							<div class="card__avatar"><img src="../../static/img/content/avatar-1.jpg" alt="Avatar" />
							</div>
							<div class="card__avatar"><img src="../../static/img/content/avatar-3.jpg" alt="Avatar" />
							</div>
		 				<div class="card__avatar"><img src="../../static/img/content/avatar-4.jpg" alt="Avatar" />
							</div>
						</div>

						<div class="card__avatar" @click="like=!like"><img src="../../static/icon/like_be.png"
								alt="Avatar" v-show="!like" />
							<img src="../../static/icon/like_af.png" alt="Avatar" v-show="like" />
						</div>
...
<script>
	export default {
		...
		methods: {
			go_item(event) {
				var itemurl = '../../pages/item/item?address=' + this.address + "&tokenid=" + this.tokenid;
				uni.navigateTo({
					url: itemurl
				});
			},
