<!--
 * @Author: OOO--li--OOO
 * @LastEditTime: 2022-04-09 22:41:52
-->
<script setup>
...
<template>
  <div class="border-4 box-content w-full rounded-md">
    <!-- <div class="container box-content bg-gray-100 min-h-[4rem] max-h-full w-6/6 flex flex-row flex-wrap "> -->
      <div class="border-dashed border-4 border-gray-300 w-40 h-40 bg-gray-400 bg-opacity-0 flex flex-col-reverse rounded-xl text-center">
        ...
        <div v-else class="btn" @click="onClick">
          选择
        </div>
      </div>
