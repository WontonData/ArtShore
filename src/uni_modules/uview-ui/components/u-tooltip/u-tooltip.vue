  ...
  computed: {
    ...
    tooltipStyle() {
      ...
      if (
        ...
        this.textInfo.left + this.textInfo.width / 2 - this.screenGap
      ) {
        this.indicatorStyle = {}
        ...
        sys.windowWidth -
          this.textInfo.right +
          this.textInfo.width / 2 -
          this.screenGap
      ) {
        this.indicatorStyle = {}
        style.right = `-${addUnit(
          sys.windowWidth - this.textInfo.right - this.screenGap
        )}`
        ...
        const left = Math.abs(
          this.textInfo.width / 2 - this.tooltipInfo.width / 2
        )
        style.left =
          this.textInfo.width > this.tooltipInfo.width
            ? addUnit(left)
            : -addUnit(left)
        this.indicatorStyle = {}
      }
