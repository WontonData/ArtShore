<template>
  <view
    ...
    :class="[
      `u-checkbox-label--${parentData.iconPlacement}`,
      parentData.borderBottom &&
        parentData.placement === 'column' &&
        'u-border-bottom',
    ]"
  >
    <view
  ...
  computed: {
    ...
    iconWrapStyle() {
      ...
      style.backgroundColor =
        this.isChecked && !this.elDisabled ? this.elActiveColor : '#ffffff'
      style.borderColor =
        this.isChecked && !this.elDisabled
          ? this.elActiveColor
    ...
    checkboxStyle() {
      ...
      if (
        ...
        this.parentData.placement === 'column'
      ) {
